...
namespace Vetements.Controllers
{
    ...
    {
        private readonly VetementsContext _context;

        public VetementsController(VetementsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string vetementGenre, string searchString)
        {
            ...
            {
                return Problem("Entity set 'VetementsContext.Vetement'  is null.");
            }
